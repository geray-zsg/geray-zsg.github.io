...
![img](https://cdn.nlark.com/yuque/0/2022/png/8425422/1663067415141-27ddf8e5-fc85-4778-ab2e-10dbaebcd253.png)

我们来简单看下以下的常见的四大主流芯片架构：

![img](https://cdn.nlark.com/yuque/0/2022/png/8425422/1663067451889-720496f0-ab02-4a79-a980-9f5b678a1014.png)
...
# 构建镜像并上传到镜像仓库
docker buildx build -t geray/hello:buildx --platform=linux/arm,linux/arm64,linux/amd64 --push .

docker buildx build -t geray/hello:buildx-v1 --platform=linux/arm,linux/arm64,linux/amd64 --push -f Dockerfile-dx .
```
